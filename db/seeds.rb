...
dallas_life = Shelter.create!(shelter_name: 'Dallas Life Foundation', address: '1100 CADIZ ST. DALLAS, TX 75215', case_management_available: false, capasity: 10)
...
dallas_life.residents.create!(family_name: 'Jerseey', long_term_housing_need: true, family_size: 3)